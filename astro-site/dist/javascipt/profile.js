document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (!targetUsername) {
        if (notLoggedInShell) {
            ...
            notLoggedInShell.innerHTML = '<article class="card bg-dark text-white shadow-lg border-0 mx-auto" style="max-width: 560px;"><div class="card-body p-4"><h2 class="h4 mb-3">No profile selected</h2><a class="btn btn-primary" href="/"><i class="bi bi-house me-2"></i>Back Home</a></div></article>';
        }
        return;
    }
    ...
    if (!user) {
        if (notLoggedInShell) {
            notLoggedInShell.style.display = 'block';
            notLoggedInShell.innerHTML = '<article class="card bg-dark text-white shadow-lg border-0 mx-auto" style="max-width: 560px;"><div class="card-body p-4"><h2 class="h4 mb-3">Profile not found</h2><p class="text-muted">This user may not have created an account yet.</p><a class="btn btn-primary" href="/"><i class="bi bi-house me-2"></i>Back Home</a></div></article>';
        }
        return;
    }
